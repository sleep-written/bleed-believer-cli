import type { LoadFSCacheInject, DirentObject, HashObject } from './interfaces/index.js';
...
class Inject implements LoadFSCacheInject {
...
test('Load cache', async t => {
    ...
    const cache = await loadFSCache('./**/*.ts', {}, inject);
